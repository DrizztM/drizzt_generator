								...
								<div id="sample-table-2_wrapper"
									...
									<form action="<%=request.getContextPath()%>/ciaAuth/list.do"
										...
										<table
											...
											<thead>
												<tr role="row">
														<th class="sorting_disabled">MOBILE_NUMBER</th>
														<th class="sorting_disabled">MOBILE_AREA</th>
														<th class="sorting_disabled">MOBILE_TYPE</th>
														<th class="sorting_disabled">AREA_CODE</th>
														<th class="sorting_disabled">POST_CODE</th>
												</tr>
											</thead>
											...
											<tbody>
												<c:forEach items="${ciaMobiles}" var="ciaMobile">
													<tr role="row" class="odd">
															<td>${ciaMobile.mobileNumber}</td>
															<td>${ciaMobile.mobileArea}</td>
															<td>${ciaMobile.mobileType}</td>
															<td>${ciaMobile.areaCode}</td>
															<td>${ciaMobile.postCode}</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
