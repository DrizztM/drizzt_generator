					...
					<form class="form-horizontal">
						<!-- #section:elements.form -->
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.imsi}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.imei}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.mac}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.bluetooth}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.androidId}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.brand}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.phoneType}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.systemVersion}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.appName}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.appVersion}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.packageName}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaDeviceApp.sdkVersion}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
