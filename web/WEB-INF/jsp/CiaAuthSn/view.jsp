					...
					<form class="form-horizontal">
						<!-- #section:elements.form -->
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaAuthSn.timestamp}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaAuthSn.step}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaAuthSn.authId}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
