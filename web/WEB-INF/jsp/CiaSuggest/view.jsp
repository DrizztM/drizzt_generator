					...
					<form class="form-horizontal">
						<!-- #section:elements.form -->
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaSuggest.title}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> content </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaSuggest.content}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> reply </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaSuggest.reply}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> issueDate </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaSuggest.issueDate}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> replyDate </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaSuggest.replyDate}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/ciaSuggest/list.do'">
