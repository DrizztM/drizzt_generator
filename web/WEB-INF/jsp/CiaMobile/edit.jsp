			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/ciaMobile/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="mobileNumber" value="${ciaMobile.mobileNumber}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> mobileArea </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="mobileArea"
											name="mobileArea" value="${ciaMobile.mobileArea}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> mobileType </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="mobileType"
											name="mobileType" value="${ciaMobile.mobileType}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> areaCode </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="areaCode"
											name="areaCode" value="${ciaMobile.areaCode}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> postCode </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="postCode"
											name="postCode" value="${ciaMobile.postCode}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/ciaMobile/list.do'">
