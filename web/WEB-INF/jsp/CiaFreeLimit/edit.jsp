			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/ciaFreeLimit/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${ciaFreeLimit.id}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="appId"
											name="appId" value="${ciaFreeLimit.appId}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="pn"
											name="pn" value="${ciaFreeLimit.pn}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> num </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="num"
											name="num" value="${ciaFreeLimit.num}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/ciaFreeLimit/list.do'">
