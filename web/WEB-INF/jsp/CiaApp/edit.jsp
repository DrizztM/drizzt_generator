			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/ciaApp/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${ciaApp.id}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="name"
											name="name" value="${ciaApp.name}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> version </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="version"
											name="version" value="${ciaApp.version}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> appId </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="appId"
											name="appId" value="${ciaApp.appId}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="authKey"
											name="authKey" value="${ciaApp.authKey}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> chargeState </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="chargeState"
											name="chargeState" value="${ciaApp.chargeState}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> openState </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="openState"
											name="openState" value="${ciaApp.openState}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> tryNum </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="tryNum"
											name="tryNum" value="${ciaApp.tryNum}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> tryState </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="tryState"
											name="tryState" value="${ciaApp.tryState}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> developerId </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="developerId"
											name="developerId" value="${ciaApp.developerId}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/ciaApp/list.do'">
