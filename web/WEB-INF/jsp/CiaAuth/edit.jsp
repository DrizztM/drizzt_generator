			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/ciaAuth/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${ciaAuth.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> transId </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="transId"
											name="transId" value="${ciaAuth.transId}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="appId"
											name="appId" value="${ciaAuth.appId}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="authKey"
											name="authKey" value="${ciaAuth.authKey}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> pn </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="pn"
											name="pn" value="${ciaAuth.pn}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> authCode </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="authCode"
											name="authCode" value="${ciaAuth.authCode}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> duration </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="duration"
											name="duration" value="${ciaAuth.duration}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="status"
											name="status" value="${ciaAuth.status}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> reason </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="reason"
											name="reason" value="${ciaAuth.reason}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/ciaAuth/list.do'">
