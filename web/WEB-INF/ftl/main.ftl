				...
				<ul class="nav ace-nav">
						...
						<ul
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#"> <img
											src="${base}/ace/assets/avatars/avatar.png" class="msg-photo"
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${base}/ace/assets/avatars/user.jpg" alt="Jason's Photo" />
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive">
			...
			<ul class="nav nav-list">
				<li class=""><a href="${base}/index.do" target="iframe"> <i
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class=""><a href="${base}/index.do" target="iframe"> <i
								class="menu-icon fa fa-caret-right"></i> 功能1
						</a> <b class="arrow"></b></li>
						<li class=""><a href="${base}/ciaAuth/list.do" target="iframe"> <i
								class="menu-icon fa fa-caret-right"></i> 功能2
						</a> <b class="arrow"></b></li>
