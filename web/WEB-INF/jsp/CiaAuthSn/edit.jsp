			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/ciaAuthSn/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${ciaAuthSn.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> timestamp </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="timestamp"
											name="timestamp" value="${ciaAuthSn.timestamp}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> step </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="step"
											name="step" value="${ciaAuthSn.step}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> authId </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="authId"
											name="authId" value="${ciaAuthSn.authId}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/ciaAuthSn/list.do'">
