										...
										<table
											...
											<thead>
												<tr role="row">
														...
														<th class="sorting_disabled">IMSI</th>
														<th class="sorting_disabled">IMEI</th>
														<th class="sorting_disabled">MAC</th>
														<th class="sorting_disabled">BLUETOOTH</th>
														<th class="sorting_disabled">ANDROID_ID</th>
														<th class="sorting_disabled">BRAND</th>
														<th class="sorting_disabled">PHONE_TYPE</th>
														<th class="sorting_disabled">SYSTEM_VERSION</th>
														<th class="sorting_disabled">APP_NAME</th>
														<th class="sorting_disabled">APP_VERSION</th>
														<th class="sorting_disabled">PACKAGE_NAME</th>
														<th class="sorting_disabled">SDK_VERSION</th>
												</tr>
											</thead>
											...
											<tbody>
												<c:forEach items="${ciaDeviceApps}" var="ciaDeviceApp">
													<tr role="row" class="odd">
															<td>${ciaDeviceApp.id}</td>
															<td>${ciaDeviceApp.imsi}</td>
															<td>${ciaDeviceApp.imei}</td>
															<td>${ciaDeviceApp.mac}</td>
															<td>${ciaDeviceApp.bluetooth}</td>
															<td>${ciaDeviceApp.androidId}</td>
															<td>${ciaDeviceApp.brand}</td>
															<td>${ciaDeviceApp.phoneType}</td>
															<td>${ciaDeviceApp.systemVersion}</td>
															<td>${ciaDeviceApp.appName}</td>
															<td>${ciaDeviceApp.appVersion}</td>
															<td>${ciaDeviceApp.packageName}</td>
															<td>${ciaDeviceApp.sdkVersion}</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
