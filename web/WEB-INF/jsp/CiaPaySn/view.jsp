					...
					<form class="form-horizontal">
						<!-- #section:elements.form -->
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaPaySn.date}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaPaySn.money}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" value="${ciaPaySn.developerId}"
											class="col-xs-10 col-sm-5" readonly="readonly"/>
									</div>
								</div>
