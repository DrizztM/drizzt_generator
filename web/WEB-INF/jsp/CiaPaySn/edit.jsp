			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/ciaPaySn/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${ciaPaySn.id}"
									class="col-xs-10 col-sm-5" />
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> money </label>
		
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="money"
											name="money" value="${ciaPaySn.money}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="developerId"
											name="developerId" value="${ciaPaySn.developerId}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info" type="button" onclick="location.href='<%=request.getContextPath()%>/ciaPaySn/list.do'">
