...
<link rel="stylesheet"
	href="${base}/ace/assets/css/font-awesome.min.css" />
...
<!-- ace styles -->
<link rel="stylesheet" href="${base}/ace/assets/css/ace.min.css"
	id="main-ace-style" />

<!--[if lte IE 9]>
			<link rel="stylesheet" href="${base}/ace/assets/css/ace-part2.min.css" />
		<![endif]-->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div>
								...
								<form action="${base}/ciaAuth/list.do" method="post" id="drizzt-table">
									<div class="row">
										<div class="col-xs-6">
									...
									<table
										...
										<thead>
											<tr role="row">
												<th class="center sorting_disabled">选择</th>
										...
										<tbody>
											...
											<tr role="row" class="odd">
												...
												<td>${ciaAuth.transId?default('')}</td>
												<td>${ciaAuth.imsi?default('')}</td>
												<td>${ciaAuth.appId?default('')}</td>
												<td>${ciaAuth.pn?default('')}</td>
												<td>${ciaAuth.duration?default('')}</td>
												<td>${ciaAuth.date?string('yyyy-MM-dd HH:mm:ss')}</td>
											</tr>
											</#list>
										</tbody>
									</table>
									<div class="row">
										<div class="col-xs-6">
											<div class="dataTables_info" id="sample-table-2_info"
												role="status" aria-live="polite">共 ${totalCount}
												条数据，当前第<input type="text" id="pageNum" name="pageNum" style="width:40px;" value="${pageNum}" />页&nbsp;&nbsp;<button class="btn btn-sm btn-primary" onclick="goPage(0)">跳转</button></div>
										</div>
										<div class="col-xs-6">
											<div class="dataTables_paginate paging_simple_numbers"
												...
												<ul class="pagination">
													<li class="paginate_button disabled"
														...
														id="sample-table-2_previous"><a href="#" onclick="goPage(1)">首页</a></li>
													<li class="paginate_button disabled"
														aria-controls="sample-table-2" tabindex="0"
														id="sample-table-2_previous"><a href="#" onclick="goPage(${pageNum}-1)">上一页</a></li>
													<li class="paginate_button"
														aria-controls="sample-table-2" tabindex="0"
														id="sample-table-2_previous"><a href="#" onclick="goPage(${pageNum}+1)">下一页</a></li>
													<li class="paginate_button"
														aria-controls="sample-table-2" tabindex="0"
														id="sample-table-2_previous"><a href="#">尾页</a></li>
												</ul>
											</div>
										</div>
									</div>
...
<script type="text/javascript">
	window.jQuery
			|| document
					.write("<script src='${base}/ace/assets/js/jquery.min.js'>"
							+ "<"+"/script>");
</script>
...
<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='${base}/ace/assets/js/jquery1x.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
<script type="text/javascript">
	if ('ontouchstart' in document.documentElement)
		document
				.write("<script src='${base}/ace/assets/js/jquery.mobile.custom.min.js'>"
						+ "<"+"/script>");
</script>
...
<script src="${base}/ace/assets/js/jquery.dataTables.min.js"></script>
<script src="${base}/ace/assets/js/jquery.dataTables.bootstrap.js"></script>
...
<link rel="stylesheet"
	href="${base}/ace/docs/assets/js/themes/sunburst.css" />
