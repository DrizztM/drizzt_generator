			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="drizzt-table" class="form-horizontal"
						action="<%=request.getContextPath()%>/ciaSuggest/edit.do"
						method="post">
						<!-- #section:elements.form -->
								<input type="hidden" id="form-field-1" name="id" value="${ciaSuggest.id}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="title"
											name="title" value="${ciaSuggest.title}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="content"
											name="content" value="${ciaSuggest.content}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="reply"
											name="reply" value="${ciaSuggest.reply}"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
